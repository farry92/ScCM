...
#         self.sct_dataset_for_transform  = deepcopy(adata_sct)
    ...
    def RandomTransform(self, sample, index):
        ...
        tr = transformation(
            self.dataset_for_transform,
#             self.sct_dataset_for_transform[index], 
            sample
        )
